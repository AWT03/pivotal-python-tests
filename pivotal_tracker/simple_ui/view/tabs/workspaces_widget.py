...
class WorkspacesWidget(QWidget):
    def __init__(self):
        ...
        self.__new_project_ids = QLineEdit()
    ...
    def __split_main_window(self):
        ...
        project_ids = ChuchusmoteSplitter().side_by_side(QLabel("New project ids"),
                                                         self.__new_project_ids)
        v_from_options = {
            (put_name, factor),
            (project_ids, factor),
            (QWidget(), factor),
    ...
    def get_put_post_data(self):
        ...
        if self.__from_options.isChecked():
            ...
            if self.__new_project_ids.text():
                data["project_ids"] = "[" + self.__new_project_ids.text() + "]"
